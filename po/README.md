# How to Translate Rakugaki

## First Things First

* Clone this repository by opening the terminal in a folder of your choice and typing ```git clone https://github.com/lainsce/rakugaki```
...
And that's it! You've successfully translated Rakugaki for your language!
